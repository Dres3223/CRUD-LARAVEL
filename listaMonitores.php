...
<?php
    ...
    <?php 
        ...
        if(isset($_GET["borrar"]) && $_GET["borrar"]=="si"){
            ...
            $ssql = "delete from monitores where cc=".$CCMonitor; 
        ...
        <div class="contenedorBoton">
            ...
            <a class="boton botonVerde" href="f_crearMonitor.php">+ nuevo</a>
</div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php 
                        ...
                        while ($row = $result->fetch_array()) { 
                            ...
                            <td>' . $row["nombre"]. '</td>
                            <td>
                                <a class="boton botonRojo"href="listaMonitores.php?borrar=si&CCMonitor='.$row["cc"].'">Borrar</a>
                                <a class="boton botonAmarillo"href="f_updateMonitor.php?CCMonitor='.$row["cc"].'">Editar</a>
                            </td>
                            </tr>'; 
                            } 
